  ...
  return (
    <>
      ...
      <div className="cancel-wrap">
        ...
        <img src="/images/Afaq1.png" alt="شعار يؤثرون" className="logo" />
      ...
      <style jsx global>{`
        ...
        body{ font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Noto Naskh Arabic", "Noto Sans Arabic", Arial; }
      ...
      <style jsx>{`
        .cancel-wrap{
          ...
          text-align:center; padding:clamp(16px,4vw,28px);
        ...
        .tint{ position:absolute; inset:0; background:rgba(0,0,0,.45); z-index:-1; }

        .logo{ width:min(160px,40vw); margin-bottom:.8rem; filter:drop-shadow(0 10px 20px rgba(0,0,0,.4)); }
        .headline{ margin:.2rem 0 .4rem; font-size:clamp(1.3rem,3.6vw,1.9rem); font-weight:900; color:#fff; }
        .lead{ margin:0 0 1.2rem; color:#e5e5e7; font-size:clamp(1rem,2.5vw,1.05rem); }
        ...
        .msg{ margin:.4rem 0 1rem; font-size:1.05rem; color:#f3f4f6; }
